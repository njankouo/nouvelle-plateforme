<nav class="navigation white">
            <div class="nav-wrapper ">
                ...
                <ul id="nav-mobile " class="navi_tab hide-on-med-and-down">
                    ...
                    <li class="active"><a href="index.php?page=mediatheque" class="black-text valign-wrapper dropdown-trigger" data-target="media_drop" >Mediathèque <span class="material-icons">expand_more</span></a></li>
                    <li><a href="index.php?page=blog" class="black-text">Blog</a></li>
                ...
                <ul id="mobile_menu" class="sidenav">
                    <li class="li_user_view valign-wrapper"><div class="user-view">
                      ...
                      <li class="active"><a href="index.php?page=mediatheque"  class="waves-effect"><i class="material-icons">video_library</i>Mediathèque</a></li>
        ...
        <div class="img_header">
            ...
            <div class="col s12 l12 valign-wrapper black mon_breadcrumb">
              ...
              <a href="#!" class="breadcrumb valign-wrapper">Nos Cours</a>
