<nav class="navigation white">
            <div class="nav-wrapper ">
                ...
                <ul class="log_sign nav-mobile right hide-on-small-only">
                    ...
                    <li class="active"><a href="index.php?page=signup" class="btn red sign white-text">Sign Up</a></li>
                ...
                <ul id="mobile_menu" class="sidenav">
                    <li class="li_user_view valign-wrapper"><div class="user-view">
                      ...
                      <li><div class="divider"></div></li>
                      <li class="active"><a href="index.php?page=signup" class="waves-effect"><i class="material-icons">person</i>Sign in</a></li>
