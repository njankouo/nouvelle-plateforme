<nav class="navigation white">
            <div class="nav-wrapper ">
                ...
                <ul id="nav-mobile " class="navi_tab hide-on-med-and-down">
                    <li class="<?php echo ($page=="home")?"active" : ""; ?>"><a href="index.php?page=home" class="black-text">Accueil</a></li>
                    <li class="<?php echo ($page=="mediatheque")?"active" : ""; ?>"><a href="index.php?page=mediatheque" class="black-text valign-wrapper dropdown-trigger" data-target="media_drop" >Mediathèque <span class="material-icons">expand_more</span></a></li>
                    <li class="<?php echo ($page=="blog")?"active" : ""; ?>"><a href="index.php?page=blog" class="black-text">Blog</a></li>
                    <li class="<?php echo ($page=="contact")?"active" : ""; ?>"><a href="index.php?page=contact" class="black-text">Contacts</a></li>
                    <!--li><a class="black-text">Onglet 4</a></!--li-->
                </ul>
                                <!-- Dropdown Structure -->
                ...
                <ul id="mobile_menu" class="sidenav">
                    <li class="li_user_view valign-wrapper"><div class="user-view">
                      ...
                      <li class="active"><a href="index.php?page=home"  class="waves-effect"><i class="material-icons">home</i>Accueil</a></li>
                      <li><a href="index.php?page=mediatheque"  class="waves-effect"><i class="material-icons">video_library</i>Mediathèque</a></li>
                      <li ><a href="index.php?page=blog"  class="waves-effect"><i class="material-icons">local_library </i>Blog</a></li>
